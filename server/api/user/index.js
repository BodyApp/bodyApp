...
router.put('/:id/referredBy', auth.isAuthenticated(), controller.referredBy);
router.put('/:id/generateSingleParentCoupon', auth.isAuthenticated(), controller.generateSingleParentCoupon);
...
router.put('/:id/createTokBoxSession', auth.isAuthenticated(), controller.createTokBoxSession);
