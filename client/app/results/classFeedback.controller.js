...
angular.module('bodyAppApp')
  .controller('ClassFeedbackCtrl', function ($scope, $state, $location, $uibModalInstance, Schedule, Auth, User) {
    ...
    //Doesn't navigate to results. Instead, closes uibModalInstance
    $scope.submitRatingAndResultsModal = function(rating, score, comment, feedback, postToPublic, minutes, seconds) {
      console.log(score);
      console.log(minutes);
      if (!rating) rating = 5.0
      if (!score) score = ""
